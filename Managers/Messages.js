class Response {
    ...
    send(content, embed) { return embed ? this.message.channel.sendMessage(content, { embed }) : this.message.channel.sendMessage(content); }
    ...
    dm(content, embed) { return embed ? this.message.author.sendMessage(content, { embed }) : this.message.author.sendMessage(content); }
}
